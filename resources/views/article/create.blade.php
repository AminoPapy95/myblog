        ...
        <form method="post" action="{{route('articles.store')}}">
            ...
            <div class="col-12">
                <div class="form-group">
                    <label>Titre</label>
                    <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" placeholder="Titre de votre aricle"/>
                    @error('title')
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <input type="text" name="subtitle" class="form-control @error('subtitle') is-invalid @enderror" placeholder="Titre de votre aricle"/>
